package com.apitest.demo.interceptor;
...
public class MybatissInterceptor implements Interceptor {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MybatissInterceptor.class);
    ...
    public Object intercept(Invocation invocation) throws Throwable {
         ...
         * System.out.println(
         * "=====================================================================");
         * System.out.println("method : {}" + method); System.out.println("param : {}"+
         * param); System.out.println("sql : {}"+ sql); System.out.println(
         * "=====================================================================");
         */
